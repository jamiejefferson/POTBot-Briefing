...
### Phase B — the pre-brief (M1, M3)

Three moves. First, *the user grills the AI* — the PDB pre-brief inverted: why this conclusion, what are you least sure of, what would change your mind; wobbles become pack fixes in front of the user, which builds their licence to challenge. Second, the **ownership pass**: at least one genuine fork chosen ("lead with cost saving or risk retired — which is yours?") and one real edit — the top-line claim re-said in the user's own words and adopted; what they chose and edited, they will defend. Third, a tutor-style walk of the pack — prediction before every reveal, "why"-shaped questions, scaffolding wherever the user lacks background so every difficulty stays winnable.
